  ...
  content title: proc{ I18n.t("active_admin.dashboard") } do
    ...
    tabs do
      ...
      tab "Weekly Report" do
        render 'admin/sales_report', context: self, date: 1.week.ago, time: "Weekly"
        render 'admin/stock_report', context: self, date: 1.week.ago, time: "Weekly"
        render 'admin/recent_added', context: self, date: 1.week.ago, time: "Weekly"
      end
